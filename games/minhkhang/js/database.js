...
const DRINKS_DB = [
    ...
    // ================= GIN =================
    { id: 'clover-club', name: 'Clover Club', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'dry-martini', name: 'Dry Martini', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'gimlet', name: 'Gimlet', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'gin-fizz', name: 'Gin Fizz', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'gin-tonic', name: 'Gin Tonic', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'james-bond', name: 'James Bond', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'negroni', name: 'Negroni', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'ramos-gin-fizz', name: 'Ramos Gin Fizz', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'singapore-sling', name: 'Singapore Sling', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'the-last-word', name: 'The Last Word', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'vesper', name: 'Vesper', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
    { id: 'white-lady', name: 'White Lady', type: 'Gin', taste: 'Chưa cập nhật', desc: '<p>Chưa có nội dung...</p>', img: '../assets/placeholder.png' },
